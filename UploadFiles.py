...
with open('characters.dat', 'wb') as file:
    chars = {
        'MainCharacter':{'Name':'', 'Sex':'', 'Class':'', 'Stats':{'Health':100, 'Defense':5,'Level':0 ,'XP':0}, 'Money':0, 'Moves':{'Attacks   ':{}, 'Defense':{}}, 'Inventory':['Small health potion', 'Medium health potion','Large health potion'],'Choices':{'Ally':''},'Progress':'', 'Journal':[]},
